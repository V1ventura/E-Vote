...
namespace CodeBehind.TiroCurto.UrnaEletronica
{
    public partial class frmUrna : Form
    {
        ...
        public frmUrna()
        {
            ...
            _dicCanditado.Add("22", new Candidato() { Id = 22, Nome = "Bolsonaro", Partido = "PL", Foto = Properties.Resources.Bolsonaro });
            _dicCanditado.Add("13", new Candidato() { Id = 13, Nome = "Lula", Partido = "PT", Foto = Properties.Resources.lula });
            _dicCanditado.Add("12", new Candidato() { Id = 12, Nome = "Ciro Gomes", Partido = "PDT", Foto = Properties.Resources.Cirogomes });
            _dicCanditado.Add("15", new Candidato() { Id = 15, Nome = "Simone", Partido = "MDB", Foto = Properties.Resources.Simone });
        }
